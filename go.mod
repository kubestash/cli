module github.com/kubestash/cli
...
require (
	...
	stash.appscode.dev/cli v0.31.0
)
...
require (
	...
	kmodules.xyz/client-go v0.25.29 // indirect
	...
	kmodules.xyz/openshift v0.25.0 // indirect
	...
	stash.appscode.dev/apimachinery v0.31.0 // indirect
	stash.appscode.dev/stash v0.31.0 // indirect
)
